...
} from "@/lib/features/plan/planSlice";
...
const EditPlan = ({ details, refreshData, closeModal }: any) => {
  ...
  const plannedActivites =
    details?.activities?.map((singleItem: any) => {
